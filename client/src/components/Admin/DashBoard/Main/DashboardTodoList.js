...
export default function DashboardTodoList(props) {
  ...
  useEffect(() => {
    axios.get(`http://pe.heromc.net:4000/todos`).then((res) => {
  ...
  const addNewTodo = (event) => {
    ...
    axios.post("http://pe.heromc.net:4000/todos", data).then((res) => {
      axios.get(`http://pe.heromc.net:4000/todos`).then((res2) => {
  ...
  const deleteTodo = (event) => {
    ...
    axios
      .post("http://pe.heromc.net:4000/todos", {
        delete: true,
        id: id,
      })
      .then((res) => {
                    ...
                    <div key={index} className="topfive-div">
                      ...
                      >
                        ...
                        <div className="todo-action flex">
                          ...
                          <div id={item._id} onClick={deleteTodo}>
                            <FontAwesomeIcon
                              icon={faTimes}
                              className="icon red"
                              style={{
