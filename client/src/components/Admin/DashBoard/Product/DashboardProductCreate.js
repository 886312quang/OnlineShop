        ...
        >
              ...
              >
                {productGroupCateList.length > 0 &&
                  productGroupCateList.map((item, index) => {
                    return <option key={index}>{item.productGroupCate}</option>;
                  })}
              </select>
              <input
                type="text"
          ...
          <div className="create-box-row flex">
            ...
            <div className="dashboard-right flex">
              <div
                className={
                  isCheckedSmall ? "size-check isChecked" : "size-check"
                }
                id="1"
                onClick={checkedSize}
              >
              ...
              <div
                className={
                  isCheckedMedium ? "size-check isChecked" : "size-check"
                }
                id="2"
                onClick={checkedSize}
              >
              ...
              <div
                className={
                  isCheckedLarge ? "size-check isChecked" : "size-check"
                }
                id="3"
                onClick={checkedSize}
              >
